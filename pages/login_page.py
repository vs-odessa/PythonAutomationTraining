...
class LoginPage:
    ...
    def login_to_jira(self):
        ...
        self.driver.find_element(*self.LOGIN_INPUT).send_keys("VolodymyrStepanov")
        self.driver.find_element(*self.PASSWORD_INPUT).clear()
        self.driver.find_element(*self.PASSWORD_INPUT).send_keys("VolodymyrStepanov")
    ...
    def open(self):
        self.driver.get("http://jira.hillel.it/secure/Dashboard.jspa")
        return self
